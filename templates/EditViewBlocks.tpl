    ...
    <div class='container-fluid editViewContainer'>
        <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
                ...
                <thead>
                    <tr>
                        <th class="blockHeader" colspan="4">{vtranslate($BLOCK_LABEL, $MODULE)}
                            <!-- Added by haidang009 -->
                            {if $BLOCK_LABEL eq 'LBL_EMAILMARKETING_CONTENT_INFORMATION'}
                ...
                <tbody>
                    <tr>
                        ...
                        {foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
                            ...
                            {/if}
                            <!-- Edited by haidang009 -->
                            <td class="fieldLabel {$WIDTHTYPE} {if $FIELD_NAME eq 'template'}hide{/if}">
                            <!-- End edit -->
            ...
            {if $FIELD_MODEL->get('uitype') neq "83"}
                <td class="fieldValue {$WIDTHTYPE}" {if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '20'} {if $FIELD_NAME eq 'template'}colspan="4"{else}colspan="3"{/if} {assign var=COUNTER value=$COUNTER+1} {/if}>
                    <div class="row-fluid">
                        <span class="span10">
